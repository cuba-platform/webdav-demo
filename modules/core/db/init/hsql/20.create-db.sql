...
alter table CONTRACTSYSTEM_CONTRACT_WEBDAV_FILE_DESCRIPTOR_LINK add constraint FK_CCWFDL_CONTRACT foreign key (CONTRACT_ID) references CONTRACTSYSTEM_CONTRACT(ID)^
alter table CONTRACTSYSTEM_CONTRACT_WEBDAV_FILE_DESCRIPTOR_LINK add constraint FK_CCWFDL_WEBDAV_FILE_DESCRIPTOR foreign key (WEBDAV_FILE_DESCRIPTOR_ID) references SYS_FILE(ID)^
